        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#6B7280' }}>
              Resourceful Labs is an AI-powered platform that guides individuals with honest, unbiased information. We're not a broker or salesperson. We're your independent advisor.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#D1FAE5' }}>
                  <Bot className="w-5 h-5" style={{ color: '#059669' }} />
                </div>
                <div className="ml-4">
