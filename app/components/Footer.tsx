...
export default function Footer() {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: '#064E3B' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Resourceful Labs</h3>
            <p style={{ color: '#A7F3D0' }}>
              Consulting families on the resources they need in moments that matter.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-4 mt-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#A7F3D0">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#A7F3D0' }} className="hover:text-white">Talk to a Consultant</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Legal</h4>
            <ul className="space-y-2">
              <li><Link href="/privacy" style={{ color: '#A7F3D0' }} className="hover:text-white">Privacy Policy</Link></li>
              <li><Link href="/terms" style={{ color: '#A7F3D0' }} className="hover:text-white">Terms of Service</Link></li>
              <li><Link href="/contact" style={{ color: '#A7F3D0' }} className="hover:text-white">Contact Us</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Contact</h4>
            <p style={{ color: '#A7F3D0' }}>support@resourcefullabs.com</p>
            <p className="mt-2" style={{ color: '#A7F3D0' }}>4 Peddlers Row #1068, Newark, DE 19702</p>
            <p className="mt-2" style={{ color: '#A7F3D0' }}>(833) 648-2917</p>
          </div>
        </div>
