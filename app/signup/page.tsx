            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2 pb-1">
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  ...
                  <a href="/privacy" style={{ color: '#059669' }} className="underline">Privacy Policy</a>
                  {' '}and{' '}
                  <a href="/terms" style={{ color: '#059669' }} className="underline">Terms of Service</a>.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="accountNotifications" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Transactional Account Notification SMS messages from Resourceful Labs at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services.
                  </label>
                </div>
                <div className="flex items-start gap-3">
