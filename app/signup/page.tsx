        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12" style={{ border: '1px solid #E5E7EB' }}>
          {submitStatus === 'success' ? (
            <div className="text-center py-12">
              ...
              <Link href="/" className="inline-block px-6 py-3 text-white font-semibold rounded-lg transition-opacity hover:opacity-90" style={{ backgroundColor: '#059669' }}>
                Return to Home
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3">
                  <input type="checkbox" id="accountNotifications" checked={accountNotifications} onChange={(e) => setAccountNotifications(e.target.checked)} className="mt-1 w-4 h-4 rounded" style={{ accentColor: '#059669' }} />
                  <label htmlFor="accountNotifications" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Account Notification SMS messages from Resource Guide at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services. See our <a href="/privacy" style={{ color: '#059669' }}>Privacy Policy</a> and <a href="/terms" style={{ color: '#059669' }}>Terms of Service</a>.
                  </label>
                </div>
                <div className="flex items-start gap-3">
                  <input type="checkbox" id="customerCare" checked={customerCare} onChange={(e) => setCustomerCare(e.target.checked)} className="mt-1 w-4 h-4 rounded" style={{ accentColor: '#059669' }} />
                  <label htmlFor="customerCare" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Customer Care SMS messages from Resource Guide at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services. See our <a href="/privacy" style={{ color: '#059669' }}>Privacy Policy</a> and <a href="/terms" style={{ color: '#059669' }}>Terms of Service</a>.
                  </label>
                </div>
              </div>
